...
#
# La geometría es la de the data layer y el patrón de mapa también (script 35): recorte,
...
#
# Run: Rscript 43_fig_mapa.R   (desde la raíz del repositorio/, después de 30)
...
DIR_RAW3 <- file.path("data", "raw")   # el crudo propio de this project
...
# de la misma escala, y ninguna marca que no sea un polígono. `the data layer` resuelve
