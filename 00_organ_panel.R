# ─────────────────────────────────────────────────────────────────────────────
# this project — Opción 1: el campo burocrático del Estado comprador
...
#
# Correr:  Rscript 00_organ_panel.R   (desde la raíz del repositorio)
# ─────────────────────────────────────────────────────────────────────────────
...
# desde la raíz del repositorio apuntan mal, así que se sobreescriben para leer los datos de
# the data layer y escribir las salidas en this project.
